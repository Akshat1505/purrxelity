...
function Sidebar() {
  ...
  return (
    <div style={{fontFamily:'GruvBox'}} className='w-30  text-white h-screen bg-[#665c54] p-4 flex flex-col justify-between fixed top-0 lef- '>
      ...
      <button onClick={()=>navigate('/login')} className='flex-col cursor-pointer mb-4 flex items-center '>
        <img className='  invert w-15 ' src="user.svg" alt="" />
